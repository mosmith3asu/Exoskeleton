...
index_start_l = [0]  # Starting index used as initial/reference frame
# index_start_l = [1000, 6000]  # Decent reference points
index_speed_l = [6]  # Index multiplier to speed up simulation by skipping points
...
def update(i):
    ...
    ax[1].set_title("Shank Displacment vs Time")
    ax[2].set_title("Knee Displacment vs Time")
    ax[3].set_title("Hip Displacment vs Time")
